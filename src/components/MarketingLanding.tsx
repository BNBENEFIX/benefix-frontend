  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative mx-auto mt-5 flex h-[100px] w-[100px] items-center justify-center overflow-hidden rounded-2xl border border-[#dce3de] bg-[#f9faf7] sm:h-[166px] sm:w-[166px]">
          <QrCode className="h-[72px] w-[72px] text-[#11271f] sm:h-[132px] sm:w-[132px]" strokeWidth={1.35} />
          <motion.div
            className="absolute inset-x-3 top-2 h-px bg-[#DC765E] shadow-[0_0_14px_3px_rgba(220,118,94,.48)]"
            animate={reduceMotion ? undefined : { y: [0, 80, 0] }}
  ...
  return (
    <main className="overflow-hidden bg-[#F4F6F1] text-[#18211D]">
      ...
      <header className="absolute inset-x-0 top-0 z-40">
        <motion.div
          className="mx-auto flex h-20 max-w-[1240px] items-center justify-between px-4 pt-[env(safe-area-inset-top)] sm:h-24 sm:px-8"
